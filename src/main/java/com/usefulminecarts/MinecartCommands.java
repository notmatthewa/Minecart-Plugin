...
import com.usefulminecarts.commands.RiderVelCommand;
...
public class MinecartCommands extends AbstractCommand {
    ...
    protected CompletableFuture<Void> execute(@Nonnull CommandContext context) {
        ...
        context.sendMessage(Message.raw("/mc ridervel - Rider settings (vel/grav/debug)"));
        context.sendMessage(Message.raw(""));
    ...
    public static class MaxSpeedCommand extends AbstractCommand {
        private final DefaultArg<String> valueArg = this.withDefaultArg("value", "speed value", ArgTypes.STRING, "", "show current value");
        ...
        @Override
        protected CompletableFuture<Void> execute(@Nonnull CommandContext context) {
            String valueStr = context.get(this.valueArg);
    ...
    public static class AccelerationCommand extends AbstractCommand {
        private final DefaultArg<String> valueArg = this.withDefaultArg("value", "acceleration value", ArgTypes.STRING, "", "show current value");
    ...
    public static class FrictionCommand extends AbstractCommand {
        private final DefaultArg<String> valueArg = this.withDefaultArg("value", "friction value", ArgTypes.STRING, "", "show current value");
    ...
    public static class CornerFrictionCommand extends AbstractCommand {
        private final DefaultArg<String> valueArg = this.withDefaultArg("value", "corner friction value", ArgTypes.STRING, "", "show current value");
    ...
    public static class SlopeBoostCommand extends AbstractCommand {
        private final DefaultArg<String> valueArg = this.withDefaultArg("value", "slope boost value", ArgTypes.STRING, "", "show current value");
    ...
    public static class UphillDragCommand extends AbstractCommand {
        private final DefaultArg<String> valueArg = this.withDefaultArg("value", "uphill drag value", ArgTypes.STRING, "", "show current value");
    ...
    public static class InitialPushCommand extends AbstractCommand {
        private final DefaultArg<String> valueArg = this.withDefaultArg("value", "initial push value", ArgTypes.STRING, "", "show current value");
    ...
    public static class RotationCommand extends AbstractCommand {
        private final DefaultArg<String> valueArg = this.withDefaultArg("value", "rotation smoothing value", ArgTypes.STRING, "", "show current value");
    ...
    // RiderVelCommand moved to separate file: com.usefulminecarts.commands.RiderVelCommand
